    ...
    <head>
        ...
        <script language=JavaScript> 
            function reload1(form)
            {
                ...
                self.location='musteri_yeni.jsp?id_il=' + val1 ;
            }
            function reload2(form)
            {
                var val1=form.id_il.options[form.id_il.options.selectedIndex].value;
                var val2=form.id_ilce.options[form.id_ilce.options.selectedIndex].value;
                self.location='musteri_yeni.jsp?id_il='+val1 +'&id_ilce='+val2;
            }
            function reload3(form)
            {
                ...
                self.location='musteri_yeni.jsp?id_il='+val1 +'&id_ilce=' + val2 + '&id_semt=' + val3; 
            }
            function reload4(form)
            {
                ...
                self.location='musteri_yeni.jsp?id_il='+val1 +'&id_ilce=' + val2 + '&id_semt=' + val3 + '&id_mahalle=' + val4; 
            }
        </script>
    </head>
    <body>
        <div id="page">
            <div id="header">
                ...
                <div id="rightheader">	
                    ...
                    <a href="musteri_giris.jsp" style="text-decoration:none;"><span>Müşteri Giriş </span></a>|
            ...
            <div id="mainpage">
                ...
                <div class='cssmenu'>
                    <ul>	
                        <li class='has-sub '><a href='giris.php'><span></br></span></a>                        
                        </li>
                    </ul>
                </div>

                <div id="yenikayit">
                    <h1><br> Müşteri Yeni Kayıt Ekranı</h1>

                    <form method="post" name=f1 action="musteri_yeni_ekle.jsp">
                        <table border="0">					
                            <tr>
                            ...
                            %>						
                            <tr>
                                <td>Sokak </td><td>:</td> <td><input type="text" name="musteri_sokak"></td>
                            </tr>
                            <tr>
                                <td>Kapı no</td><td>:</td> <td><input type="text" name="musteri_kapi_no"></td>
                            </tr>
                            <tr>
                                <td colspan="3" align="center"><h4>Musteri Bilgilerini Giriniz</h4></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Müşteri Adı</td><td>:</td> <td><input type="text" name="musteri_ad"></td>
                            </tr>
                            <tr>
                                <td>Müşteri Soyadı</td><td>:</td> <td><input type="text" name="musteri_soyad"></td>
                            </tr>
                            <tr>
                                <td>Tel</td><td>:</td> <td><input type="text" name="musteri_tel"></td>
                            </tr>
                            <tr>
                                <td>E-mail</td><td>:</td> <td><input type="text" name="musteri_email"></td>
                            </tr>
